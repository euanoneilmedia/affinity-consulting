...
export function Eyebrow({ children, className, variant = "default" }: EyebrowProps) {
  const variantStyles = {
    default: "border-brand-primary/30 bg-brand-primary/5 text-brand-primary hover:bg-brand-primary/10",
    ...
    accent: "border-brand-secondary/30 bg-brand-secondary/5 text-brand-secondary hover:bg-brand-secondary/10",
  };
